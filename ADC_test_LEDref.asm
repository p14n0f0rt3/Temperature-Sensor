...
; Configure the serial port and baud rate (taken from 'Hello.asm')
InitSerialPort:
...
Forever:
	...
	mov x+2, #0
	mov x+3, #0
	Load_y(20527) ; The MEASURED LED voltage: 2.074V, with 4 decimal places
	lcall mul32
	...
	;voltage is kelvin value / 100
	;thus to convert to kelvin I multiply by 100:
	Load_y(100)
	lcall mul32
	;now our value, stored in x
	;is in degrees celcius

	lcall Display_formated_BCD

	;converts hex value into bcd
	lcall hex2bcd
